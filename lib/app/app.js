...
class App {
    ...
    initialize(options) {
        ...
        _.forEach(this._routes, (route) => route.middlewareHandler = [...this._middlewares, ...route.middlewareHandler]);
    ...
    _findRoute(req) {
        ...
        for (let i = 0; i < this._routesLength; i++) {
            ...
            match = route.regExp.exec(util_1.Util.addSlashEnd(req.urlParse.pathname));
